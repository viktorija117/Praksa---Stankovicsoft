<nav x-data="{ open: false }" class="p-3 mb-2 bg-primary text-white">
            ...
            <div class="flex">
                ...
                <div class="  items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="images/logoSkola.png" alt="School Logo" class="block h-12 w-auto my-2 fill-current text-gray-800 dark:text-gray-200" >
                    </a>
                </div>
